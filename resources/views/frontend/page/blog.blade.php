                        ...
                        <div class="col-md-4 mb-3">
                            <div class="shadow py-2 ">
                                <div class="card-activities-list d-flex align-items-center gap-4">
                                    ...
                                    <p>
                                        <a href="{{ route('blogsingle',$pck->slug) }}" class="headlink d-flex mt-2 text-start">{{ $pck->name ?? '' }}</a>
                                        <a href="{{ route('blogsingle', $pck->slug) }}" class="text-link">Read More</a>
                                    </p>
                                </div>
                            </div>
                        </div>
