                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 row align-items-center">
                            ...
                            <div class="col-md-8 col-sm-12 px-1 py-1"><input class="form-control" type="text" placeholder="Departure City">
                            </div>
                        </div>
                        <div class="col-12 row align-items-center">
                            <div class="col-md-4 col-sm-12 p-0 ps-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12 px-1 py-1">
                            <input class="form-control" type="email"  placeholder="john@doe.com">
                        </div>
                        </div>
                        <div class="col-12 row align-items-center">
                        <div class="col-md-4 col-sm-12 p-0 ps-2">
                        ...
                        <div class="col-md-8 col-sm-12 px-1 py-1">
                            <input class="form-control" type="number" placeholder="989 989 9898">
                        </div>
                        </div>
                        <div class="col-12 row align-items-center">
                        <div class="col-md-4 col-sm-12 p-0 ps-2">
                    ...
                    <div class="col-md-12 col-sm-12 px-1 py-1">
                        <textarea class="form-control p-2" rows="6" placeholder="Write Your Message..."></textarea>
                    </div>
                    </div>
                    <div class="col-12 text-center mt-3">
                    <button type="submit" class="btn btn-primary-200 text-white px-4 py-2">Submit <i class="fa-regular fa-paper-plane"></i></button>
                    </div>            
                </div>
            </form> 
        </div>
