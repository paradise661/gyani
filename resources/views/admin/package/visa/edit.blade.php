    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Details "{{ $packagevisa->title }}"</h5>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('packagevisa.update', [$package_id, $packagevisa->id]) }}"
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control @error('question') is-invalid @enderror" id=""
                                type="text" value="{{ old('question', $packagevisa->question) }}" name="question"
                                placeholder="">
                            @error('question')
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control @error('order') is-invalid @enderror" id="" type="number"
                                value="{{ old('order', $packagevisa->order) }}" name="order" placeholder="">
                            @error('order')
                                <div class="invalid-feedback" style="display: block;">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('answer') is-invalid @enderror ckeditor" id="" name="answer"
                            rows="8" placeholder="">{{ old('answer', $packagevisa->answer) }}</textarea>
                        @error('answer')
                            <div class="invalid-feedback" style="display: block;">
                                {{ $message }}
                            </div>
