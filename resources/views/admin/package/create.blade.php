                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control inclusioneditor" id="" name="inclusion" cols="30" rows="10">{{ old('inclusion') }}
                                                </textarea>
                                                @error('inclusion')
                                                    <div class="invalid-feedback" style="display: block;">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control exclusioneditor" id="" name="exclusion" cols="30" rows="10">{{ old('exclusion') }}
                                                </textarea>
                                                @error('exclusion')
                                                    <div class="invalid-feedback" style="display: block;">
                                                        {{ $message }}
                    ...
                    <div class="col-md-4">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('destination') is-invalid @enderror" id=""
                                    type="text" name="destination" value="{{ old('destination') }}" placeholder="">
                                @error('destination')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card-body card shadow my-3 br-8">
                            <div class="form-group mb-3 mt-2 d-flex justify-content-between">
                                <a class="btn btn-primary" href="javascript:void(0)"><i class="fa fa-list-ol"></i>
                                    Itinerary</a>
                                <a class="btn btn-primary" href="javascript:void(0)"><i class="fa fa-question"></i>
                                    Faq</a>
                                <a class="btn btn-primary" href="javascript:void(0)"><i class="fa fa-plane"></i> Visa
                                </a>
                                {{-- <a class="btn btn-primary" href="javascript:void(0)"><i class="fa fa-images"></i>
                                    Gallery</a> --}}
                            </div>
                        </div>
                    </div>
