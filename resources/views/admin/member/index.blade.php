    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end">
                <a href="{{ route('members.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
                    Create</a>
            </small>
        </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($member as $key => $blog)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('members.edit', $blog->id) }}"
                                    ...
                                    <form class="delete-form" action="{{ route('members.destroy', $blog->id) }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger delete_member mr-2" id=""
