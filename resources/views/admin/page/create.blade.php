    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            ...
            <div class="card-body p-0">
                <form method="POST" class="row" action="{{ route('page.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select name="template" id="template" class="form-select ms-3">
                                    <option value="0" class="p-3">Default Template</option>
                                    <option value="1" class="p-3">Side-To-Side</option>
                                    <option value="2" class="p-3">About Us</option>
                                    <option value="9" class="p-3">Contact Us</option>
                                    <option value="14" class="p-3">All Packages</option>
                                    <option value="15" class="p-3">Packages Category</option>
                                    <option value="3" class="p-3">Teams</option>
                                    <option value="4" class="p-3">Reviews</option>
                                    <option value="5" class="p-3">Faqs</option>
                                    <option value="6" class="p-3">Partners</option>
                                    <option value="8" class="p-3">Gallery</option>
                                    <option value="10" class="p-3">Blogs</option>
                                    <option value="11" class="p-3">Services</option>
                                    <option value="13" class="p-3">Booking</option>
                                    <option value="16" class="p-3">Sitemap</option>
                                </select>
                            </div>
