    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end">
                <a href="{{ route('page.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
                    Create</a>
            </small>
        </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($page as $key => $blog)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('pagesingle', $blog->slug) }}" target="_blank"
                                    ...
                                    <a href="{{ route('page.edit', $blog->id) }}"
                                        ...
                                        <form class="delete-form" action="{{ route('page.destroy', $blog->id) }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger delete_page mr-2" id=""
