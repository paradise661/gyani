    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end">
                <a href="{{ route('galleries.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i>
                    Back</a>
            </small>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-body">
                    <form action="{{ route('galleries.store') }}" method="POST" class="dropzone" id="dropzone"
