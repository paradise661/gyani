...
class MenuController extends Controller
{
    public function index()
    {
        ...
        return view('admin.menu.index', ['posts' => News::all(), 'pages' => Page::all(), 'services' => Services::all(), 'categorys' => PackageCategory::all(), 'packages' => Package::all(), 'menus' => MenuLocation::all(), 'desiredMenu' => $desiredMenu, 'menuitems' => $menuitems]);
    }
    ...
    public function addPostToMenu(Request $request)
    {
        ...
        if ($menu->content == '') {
            foreach ($ids as $id) {
                ...
                $data['slug'] = '/blog/' . News::where('id', $id)->value('slug');
                $data['type'] = 'post';
                $data['menu_id'] = $menuid;
            ...
            foreach ($ids as $id) {
                ...
                $array['slug'] = '/blog/' . News::where('id', $id)->value('slug');
                $array['name'] = NULL;
                $array['type'] = 'post';
                $array['target'] = NULL;
    ...
    public function addPackageToMenu(Request $request)
    {
        $data = $request->all();
        $menuid = $request->menuid;
        $ids = $request->ids;
        ...
        if ($menu->content == '') {
            foreach ($ids as $id) {
                $data['title'] = Package::where('id', $id)->value('name');
                $data['slug'] = '/packages/' . Package::where('id', $id)->value('slug');
                $data['type'] = 'package';
                $data['menu_id'] = $menuid;
                $data['updated_at'] = NULL;
                Menu::create($data);
            ...
            foreach ($ids as $id) {
                $array['title'] = Package::where('id', $id)->value('name');
                $array['slug'] = '/packages/' . Package::where('id', $id)->value('slug');
                $array['name'] = NULL;
                $array['type'] = 'package';
                $array['target'] = NULL;
                $array['id'] = Menu::where('slug', $array['slug'])->where('name', $array['name'])->where('type', $array['type'])->orderby('id', 'DESC')->value('id');
    ...
    public function addCategoryToMenu(Request $request)
    {
        ...
        if ($menu->content == '') {
            foreach ($ids as $id) {
                $data['title'] = PackageCategory::where('id', $id)->value('name');
                $data['slug'] = '/category/' . PackageCategory::where('id', $id)->value('slug');
                $data['type'] = 'category';
                $data['menu_id'] = $menuid;
                $data['updated_at'] = NULL;
                Menu::create($data);
            ...
            foreach ($ids as $id) {
                $array['title'] = PackageCategory::where('id', $id)->value('name');
                $array['slug'] = '/category/' . PackageCategory::where('id', $id)->value('slug');
                $array['name'] = NULL;
                $array['type'] = 'category';
                $array['target'] = NULL;
                $array['id'] = Menu::where('slug', $array['slug'])->where('name', $array['name'])->where('type', $array['type'])->orderby('id', 'DESC')->value('id');
